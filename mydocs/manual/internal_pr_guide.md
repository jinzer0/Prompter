...
이 문서는 내부 task PR 본문 작성 규칙을 정의한다. 내부 task PR은 `local/task{번호}`에서 작업한 내용을 `publish/task{번호}`로 push한 뒤 `master` 대상으로 생성한다.
...
- **[Stage 1](https://github.com/jinzer0/Prompter/blob/{sha}/mydocs/working/task_m050_22_stage1.md)** ([abc1234](https://github.com/jinzer0/Prompter/commit/{stage1_sha})): {Stage 1 요약}
- **[Stage 2](https://github.com/jinzer0/Prompter/blob/{sha}/mydocs/working/task_m050_22_stage2.md)** ([def5678](https://github.com/jinzer0/Prompter/commit/{stage2_sha})): {Stage 2 요약}
...
- 수행 계획서: [task_m050_22.md](https://github.com/jinzer0/Prompter/blob/{sha}/mydocs/plans/task_m050_22.md)
- 구현 계획서: [task_m050_22_impl.md](https://github.com/jinzer0/Prompter/blob/{sha}/mydocs/plans/task_m050_22_impl.md)
- 최종 보고서: [task_m050_22_report.md](https://github.com/jinzer0/Prompter/blob/{sha}/mydocs/report/task_m050_22_report.md)
